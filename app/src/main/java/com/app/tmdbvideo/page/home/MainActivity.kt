...
class MainActivity : ComponentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        detailViewModel = ViewModelProvider(this,modelFactory)[DetailViewModel::class.java]
        setContent {
            TMDBVideoTheme {
                ...
                Surface(
                    ...
                    ScreenHome(mainViewModel = mainViewModel, detailViewModel = detailViewModel)
                }
            }
        }
    }
...
@Composable
fun ScreenHome(mainViewModel: MainViewModel,detailViewModel: DetailViewModel,startPosition : String = Routes.HomeViewScreen.routes){
    ...
    NavHost(navController = navController, startDestination = startPosition){
        ...
        composable("${Routes.DetailMovieViewScreen.routes}/{movieId}"){
            ...
            movieId?.let {
                DetailMovieScreenPage(detailViewModel = detailViewModel,movieId,navController)
            }
        }
        ...
        composable("${Routes.DetailTvViewScreen.routes}/{seriesId}"){
            ...
            seriesId?.let {
                DetailTvScreenPage(detailViewModel = detailViewModel,seriesId,navController)
            }
        }
